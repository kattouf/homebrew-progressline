class Progressline < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/kattouf/ProgressLine/releases/download/#{version}/progressline-#{version}-arm64-apple-macosx.zip"
      sha256 "7b885bc415c9339a2944c8651bbf46320002f294ee4bd42deff3ad7505bec4c8"
    else
      url "https://github.com/kattouf/ProgressLine/releases/download/#{version}/progressline-#{version}-x86_64-apple-macosx.zip"
  ...
  on_linux do
    if Hardware::CPU.arm?
      url "https://github.com/kattouf/ProgressLine/releases/download/#{version}/progressline-#{version}-aarch64-unknown-linux-gnu.zip"
      sha256 "3762a05bba3b7218fbd7d16445634929d0ddd6825952cf8996a0457264ece52c"
    else
      url "https://github.com/kattouf/ProgressLine/releases/download/#{version}/progressline-#{version}-x86_64-unknown-linux-gnu.zip"
